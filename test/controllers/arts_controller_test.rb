...
class ArtsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create art" do
    assert_difference('Art.count') do
      post arts_url, params: { art: { Author: @art.Author, Date: @art.Date, Description: @art.Description, Picture: @art.Picture, Title: @art.Title } }
    end
  ...
  test "should update art" do
    patch art_url(@art), params: { art: { Author: @art.Author, Date: @art.Date, Description: @art.Description, Picture: @art.Picture, Title: @art.Title } }
